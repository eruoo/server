...
> 2026-09-09 补充：本文保留当时的确认原文。owner 后续提出无感续期需求，当前目标已改为原生 30 天滚动 Session、24 小时更新间隔，并保留 15 分钟敏感操作重认证；下文“30 天固定”是历史策略。新目标、身份载体分类与差异由 [完整架构规格](architecture.md#11-唯一维护位置) 维护，不能把本记录或核心探针通过视为完整新架构已验收。
