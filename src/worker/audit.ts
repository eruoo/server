...
const metadataFields: Record<AuditEventType, readonly string[]> = {
  ...
  ai_connection_updated: ["connectionId", "providerType"],
  api_key_created: ["status", "configId", "modelGrantCount"],
  api_key_updated: ["status", "configId", "modelGrantCount"],
  api_key_revoked: ["status", "configId"],
