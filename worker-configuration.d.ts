/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging --strict-vars=false` (hash: 30975b762a482d50d9a1fa07c04b4a43)
// Runtime types generated with workerd@1.20260815.1 2026-08-19 enable_request_signal,nodejs_compat
interface __BaseEnv_Env {
	...
	AI_CREDENTIAL_KEYS: string;
	DATABASE_BACKUP_WORKFLOW: Workflow<Parameters<import("./src/worker/index").DatabaseBackupWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "OWNER_GITHUB_ID" | "CF_ACCOUNT_ID" | "D1_DATABASE_ID" | "BETTER_AUTH_SECRETS" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "AUDIT_IP_HASH_SECRET" | "D1_EXPORT_API_TOKEN" | "AI_CREDENTIAL_KEYS">> {}
}
